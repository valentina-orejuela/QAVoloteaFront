...
import static com.speedup.qa.userinterface.OriginInterface.VALIDATE_NUMBER_BABY;

public class SelectBaby implements Question<String> {
    @Override
    public String answeredBy(Actor actorQuestionBaby) {
        return BrowseTheWeb.as(actorQuestionBaby).find(VALIDATE_NUMBER_BABY).getText();
    }
